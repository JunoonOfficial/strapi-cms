  ...
  attributes: {
    ...
    folderPath: Attribute.String &
      ...
      Attribute.SetMinMax<
        ...
        number
      >;
    base64: Attribute.Text & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::upload.file',
...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    ...
    about: Attribute.Component<'home.about-section'>;
    featured: Attribute.Component<'home.featured'>;
    story: Attribute.Component<'home.story-section'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiLogoLogo extends Schema.SingleType {
  ...
  attributes: {
    fullWhite: Attribute.Media;
    fullBlack: Attribute.Media;
    smallWhite: Attribute.Media;
    logoOnlyWhite: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiReelReel extends Schema.SingleType {
...
export interface ApiStorygramStorygram extends Schema.CollectionType {
  collectionName: 'storygrams';
  info: {
    singularName: 'storygram';
    pluralName: 'storygrams';
    displayName: 'Storygram';
    description: '';
  };
  options: {
    draftAndPublish: true;
...
export interface ApiTeamTeam extends Schema.SingleType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    coordinator: Attribute.String & Attribute.Required;
    ...
    descriptionHead: Attribute.String;
    descriptionSubhead: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiWallpaperWallpaper extends Schema.SingleType {
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::storygram.storygram': ApiStorygramStorygram;
